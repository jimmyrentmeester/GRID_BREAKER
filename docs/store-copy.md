# App Store listing copy — GRID_BREAKER
...
One thumb. Pure reaction. No filler.
...
• CAMPAIGN — 10 hand-tuned data cores, each teaching one new mechanic, ramping to a real finale.
• FLOW — a calm, no-fail mode to just tap and unwind.
