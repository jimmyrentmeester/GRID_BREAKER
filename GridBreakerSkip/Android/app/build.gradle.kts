...
plugins {
    // NOTE: skip 1.8.16 scaffold ships a stale `alias(libs.plugins.kotlin.android)`
    // here, but the generated version catalog (AGP 9.x has built-in Kotlin support)
    // no longer defines a kotlin-android alias → "Unresolved reference 'android'".
    // The generated library module proves it isn't needed; removed.
...
android {
    ...
    buildTypes {
        release {
            ...
            // AGP 9.x removed proguard-android.txt (it forced -dontoptimize); use the optimizing variant.
