...
internal val logger: SkipLogger = SkipLogger(subsystem = "grid.breaker", category = "GridBreaker")

private typealias AppRootView = GridBreakerRootView
private typealias AppDelegate = GridBreakerAppDelegate
